...
#############################################################
file_paths <- dir(file_Location, pattern = "*.Nuclei", full.names = TRUE)
file_paths2 <- dir(file_Location, pattern = "*.periphery", full.names = TRUE)
#############################################################
...
normalized_dist <- normalized_dist +
  ...
  labs(title = NULL, y = "Count", x = "% Decrease in MLF2-GFP")
 } else {
normalized_dist <- normalized_dist +
  ...
  labs(title = NULL, y = "Count", x = "% Increase in MLF2-GFP")
 } 
