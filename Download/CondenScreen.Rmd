...
save_Location <- "D:/CRISPR_Screen_Analysis_dp/Pharmakon1760/Pharmakon_1760_final_analysios_5_14_25/"
#############################################################
...
#############################################################
file_paths <- dir(file_Location, pattern = "*.shape_size_intensity", full.names = TRUE)
...
normalized_dist <- normalized_dist +
  ...
  labs(title = NULL, y = "Count", x = "% Decrease in MLF2-GFP Foci")
 } else {
normalized_dist <- normalized_dist +
