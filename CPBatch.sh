...
nimages=30240 #Change to total number of images (each plate has 3024 images, multiply by number of plates.) #Currently set for analyzing 10 plates with 3024 images each
iperjob=3024
